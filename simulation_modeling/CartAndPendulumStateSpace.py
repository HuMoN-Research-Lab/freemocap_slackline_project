...
class Pendulum:
    ...
    def set_pid_gains(self):
        ...
        self.proportional_gain_pendulum_angle = 20 #30
        self.integral_gain_pendulum_angle = 10 #10
        self.derivative_gain_pendulum_angle = 7 #10

        # gains for cart position
        self.proportional_gain_cart_position = 0.5 #1
        self.integral_gain_cart_position = 5 #10
        self.derivative_gain_cart_position = 1.5 #3
    ...
    def derivatives(self, state, t):
        ...
        noise_array = self.generate_noise(0.0000002)
